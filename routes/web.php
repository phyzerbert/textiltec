...
Route::any('/workshop/order/{id}', 'WorkshopController@produce_order')->name('workshop.order');
Route::any('/workshop/payment/{id}', 'WorkshopController@payment')->name('workshop.payment');
Route::any('/workshop/receive/{id}', 'WorkshopController@receiption')->name('workshop.receive');

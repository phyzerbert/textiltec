<form action="" method="POST" class="form-inline float-left" id="searchForm">
    @csrf
    <input type="text" class="form-control form-control-sm mr-sm-2" name="code" id="search_code" value="{{$code}}" placeholder="{{__('page.product_code')}}">
    <input type="text" class="form-control form-control-sm mr-sm-2" name="name" id="search_name" value="{{$name}}" placeholder="{{__('page.product_name')}}">
    <select class="form-control form-control-sm mr-sm-2" name="category_id" id="search_category">

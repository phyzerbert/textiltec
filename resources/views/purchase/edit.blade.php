    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-layout form-layout-1" action="{{route('purchase.update')}}" method="POST" enctype="multipart/form-data" id="app">
                            @csrf
                            <input type="hidden" name="id" class="id" id="purchase_id" value="{{$purchase->id}}">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="col-form-label">{{__('page.purchase_date')}} <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="date" id="purchase_date" v-model="date" placeholder="{{__('page.purchase_date')}}" autocomplete="off" required>
                                        @error('date')
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-colored table-success" id="supply_order_table">
                                            <thead>
                                                <tr>
                                                    <th>{{__('page.name')}}</th>
...
@section('script')
    ...
    <script src="{{ asset('master/js/purchase_edit_order_items.js') }}"></script>
    <script>

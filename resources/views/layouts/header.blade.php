        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <a class="nav-link nav-link-user dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
                    <img src="{{asset('images/avatar.png')}}" class="avatar img-fluid rounded mr-1" alt="{{$user->first_name}} {{$user->last_name}}" /> <span class="text-dark">{{$user->first_name}} {{$user->last_name}}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#"><i class="align-middle" data-feather="user"></i> Profile</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('logout') }}"
                        onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();"
                    ><i class="align-middle" data-feather="log-out"></i> Sign out</a>
                </div>

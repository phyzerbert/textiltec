...
@section('content')
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3"><i class="fa fa-cubes"></i> {{__('page.product_sale')}}</h1>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-layout form-layout-1" action="{{route('product_sale.save')}}" method="POST" enctype="multipart/form-data" id="app">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="col-form-label">{{__('page.date')}} <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="date" id="product_sale_date" value="{{date('Y-m-d H:i')}}"placeholder="{{__('page.product_sale_date')}}" autocomplete="off" required>
                                        @error('date')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">                                  
                                            <select class="form-control select2" name="customer" id="search_customer" required>
...
@section('script')
    ...
    <script src="{{ asset('master/js/product_sale_order_items.js') }}"></script>
    <script>
        $(document).ready(function(){
            ...
            $('.select2').each(function() {
                $(this)
                    ...
                    .select2({
                        width: 'resolve',
                        placeholder: "{!! __('page.select_customer') !!}"
                    });                    
            });
